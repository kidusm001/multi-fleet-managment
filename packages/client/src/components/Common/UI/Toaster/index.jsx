  ...
  return (
    <ToastPrimitives.Root
      ...
      className={cn(
        ...
        {
          "border-slate-900 bg-slate-950 text-slate-50": variant === "default",
          "destructive group border-red-500 bg-red-500 text-slate-50": variant === "destructive",
          "border-green-500 bg-green-500 text-slate-50": variant === "success",
        },
        className
      )}
      {...props}
