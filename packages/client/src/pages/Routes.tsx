...
import RouteManagementView from "./routes/components/RouteManagementView/index.jsx";
import CreateRoute from "./routes/components/CreateRoute/index.jsx";
import "./routes/RouteManagement.css";
        ...
        <div className="">
          {activeTab === "management" ? (
            ...
            <div className="p-6 text-sm text-[var(--text-secondary)]">
              Assignment view is coming soon.
            </div>
          ) : (
            <CreateRoute onRouteCreated={() => setRefreshTrigger(Date.now())} />
          )}
        </div>
      </div>
    </div>
